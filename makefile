opl : main.o parser.o function.o data.o gbc.o cell.o error.o bignum.o compute.o edit.o
	gcc  -O3 -Wno-pointer-to-int-cast -Wall  main.o parser.o function.o data.o gbc.o cell.o error.o bignum.o compute.o edit.o -o opl -lm -ldl
main.o : main.c opl.h
	gcc -O3 -Wno-pointer-to-int-cast -Wall -c main.c -lm
parser.o : parser.c opl.h
	gcc -O3 -Wno-pointer-to-int-cast -Wall -c parser.c -lm
