...
enum { CAR_IDX, CDR_IDX, CADR_IDX, CADDR_IDX, CADAR_IDX, PRINT_IDX, MAKEINT_IDX,
...
enum { CONS_IDX, PLUS_IDX, MINUS_IDX, MULT_IDX, DEVIDE_IDX, S_REMAINDER_IDX,
       QUOTIENT_IDX, EQP_IDX, NUMEQP_IDX, SMALLERP_IDX, EQSMALLERP_IDX,
       GREATERP_IDX, EQGREATERP_IDX, UNIFY_IDX, MOD_IDX, EXPT_IDX, SQRT_IDX,
       LEFTSHIFTIDX, RIGHTSHIFT_IDX, LOGICALAND_IDX, LOGICALOR_IDX, LISTCONS_IDX,
       ...
       ADDTAIL_IDX, NTH_IDX, UNIFY_CONST_IDX, UNIFY_VAR_IDX, UNIFY_NIL_IDX,
       PROVE_ALL_IDX,
       NUM_FN2S
};
