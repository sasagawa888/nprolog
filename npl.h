...
int b_atom_chars(int arglist, int rest);
int b_atom_codes(int arglist, int rest);
int b_atom_concat(int arglist, int rest);
int b_atom_length(int arglist, int rest);
...
int b_body(int arglist, int rest);
...
int b_current_prolog_flag(int arglist, int rest);
...
int b_string_chars(int arglist, int rest);
int b_string_codes(int arglist, int rest);
