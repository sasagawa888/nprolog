...
{body = Jwlist3(Jmakeope(","),Jwcons(1159,Jwcons(varX,NIL,th),th),Jwlist3(Jmakeope(","),Jwcons(172,Jwcons(varX1,Jwcons(Jwcons(1811,Jwcons(varX,Jwcons(Jmakeint(1),NIL,th),th),th),NIL,th),th),th),Jwcons(Jmakecomp("foo"),Jwcons(varX1,Jwcons(Jmakeint(2),NIL,th),th),th),th),th);
