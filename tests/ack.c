...
save2 = Jget_sp();
n = Jlength(arglist);
if(n == 3){varN = Jmakevariant();
varX = Jmakevariant();
save1 = Jget_wp();
if(Junify(Jwcons(Jmakeint(0),Jwcons(varN,Jwcons(varX,NIL))),arglist) == YES)
...
varX = Jmakevariant();
save1 = Jget_wp();
if(Junify(Jwcons(varM,Jwcons(Jmakeint(0),Jwcons(varX,NIL))),arglist) == YES)
...
varX = Jmakevariant();
save1 = Jget_wp();
if(Junify(Jwcons(varM,Jwcons(varN,Jwcons(varX,NIL))),arglist) == YES)
