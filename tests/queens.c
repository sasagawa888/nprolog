...
save1 = Jget_wp();
{body = Jwlist3(Jmakeope(","),Jwcons(Jmakecomp("between"),Jwcons(Jmakeint(1),Jwcons(Jmakeint(16),Jwcons(varX,NIL)))),Jwlist3(Jmakeope(","),Jmakecomp("test"),246));
...
if(n == 0){varX = Jmakevariant();
save1 = Jget_wp();
{body = Jwlist3(Jmakeope(","),Jwcons(Jmakecomp("queen"),Jwcons(Jwlistcons(Jmakeint(1),Jwlistcons(Jmakeint(2),Jwlistcons(Jmakeint(3),Jwlistcons(Jmakeint(4),Jwlistcons(Jmakeint(5),Jwlistcons(Jmakeint(6),Jwlistcons(Jmakeint(7),Jwlistcons(Jmakeint(8),Jwlistcons(Jmakeint(9),NIL))))))))),Jwcons(varX,NIL))),Jwlist3(Jmakeope(","),Jwcons(352,Jwcons(varX,NIL)),Jwlist3(Jmakeope(","),292,246)));
if(Jprove_all(Jaddtail_body(rest,body),Jget_sp(),0) == YES)
return(YES);}
Junbind(save2);
Jset_wp(save1);
...
{body = Jwlist3(Jmakeope(","),Jwcons(80,Jwcons(varD,Jwcons(Jwcons(508,Jwcons(varN,Jwcons(varB,NIL))),NIL))),Jwlist3(Jmakeope(","),Jwcons(80,Jwcons(varD,Jwcons(Jwcons(508,Jwcons(varB,Jwcons(varN,NIL))),NIL))),Jwlist3(Jmakeope(","),Jwcons(116,Jwcons(varD1,Jwcons(Jwcons(466,Jwcons(varD,Jwcons(Jmakeint(1),NIL))),NIL))),Jwcons(Jmakecomp("nodiag"),Jwcons(varL,Jwcons(varB,Jwcons(varD1,NIL)))))));
if(Jprove_all(Jaddtail_body(rest,body),Jget_sp(),0) == YES)
return(YES);}
Junbind(save2);
Jset_wp(save1);
