...
void initbuiltin(void){
    ...
    defcompiled("append",b_append,3);
    defcompiled("member",b_member,2);
    ...
    defbuiltin("n_strict",b_strict,-1);

     #ifdef __arm__
    defbuiltin("wiringpi_setup_gpio",b_wiringpi_setup_gpio,2);
    defbuiltin("wiringpi_spi_setup_ch_speed",b_wiringpi_spi_setup_ch_speed,1);
