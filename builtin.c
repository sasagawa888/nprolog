...
initbuiltin (void)
{
  ...
  defbuiltin ("ansi_cup", b_ansi_cup, 0);
  defbuiltin ("ansi_cuu", b_ansi_cuu, 0);
  defbuiltin ("ansi_cud", b_ansi_cud, 0);
  defbuiltin ("ansi_cuf", b_ansi_cuf, 0);
  defbuiltin ("ansi_cub", b_ansi_cub, 0);
  defbuiltin ("ansi_sgr", b_ansi_sgr, 0);
  defbuiltin ("ansi_cpr", b_ansi_cpr, 0);
...
int
b_notunify (int arglist, int rest)
{
  int n, arg1, arg2, res;
...
int
b_write_canonical (int arglist, int rest)
{
  int n, arg1, arg2, save;
...
int
b_get0_noecho (int arglist, int rest)
{
  int n, c, arg1, i, res;
...
int
b_get_code (int arglist, int rest)
{
...
int
b_get_byte (int arglist, int rest)
{
...
int
b_read_line (int arglist, int rest)
{
...
int
b_stdinout (int arglist, int rest)
{
...
b_create (int arglist, int rest)
{
  ...
  if (n == 2)
	...
	{
	  stream =
	    makestream (fopen (GET_NAME (arg2), "w"), OPL_OUTPUT, OPL_TEXT,
			NIL, arg2);
  ...
  if (n == 3)
      ...
      else
	{
	  ...
	  if (arg3 == makeconst ("w"))
	    ...
	    {
	      stream =
		makestream (fopen (GET_NAME (arg2), "r"), OPL_INPUT, OPL_TEXT,
			    NIL, arg2);
...
b_tell (int arglist, int rest)
{
  ...
  if (n == 1)
	...
	{
	  output_stream =
	    makestream (fopen (GET_NAME (arg1), "w"), OPL_OUTPUT, OPL_TEXT,
			NIL, arg1);
...
int
b_telling (int arglist, int rest)
{
  int n, arg1;
...
int
b_flush_output (int arglist, int rest)
{
  int n, arg1;
...
int
b_consult (int arglist, int rest)
{
  ...
  if (n == 1)
	...
	error (NOT_ATOM, "consult ", arg1);
      ...
      save = input_stream;
      input_stream =
	makestream (fopen (GET_NAME (arg1), "r"), OPL_INPUT, OPL_TEXT, NIL,
		    arg1);
...
int
b_reconsult (int arglist, int rest)
{
...
*/
void
memoize_arity (int clause, int atom)
{
  if (predicatep (clause) || user_operation_p (clause))
    {
	...
	{
	  SET_ARITY (atom,
		     cons (makeint (length (cdr (clause))),
			   GET_ARITY (atom)));
	}
    }
  else
...
int
b_directory (int arglist, int rest)
{
...
int
b_greater (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_smaller (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_eqsmaller (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_eqgreater (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_notnumeq (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_notequalp (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_compare (int arglist, int rest)
{
...
int
b_atsmaller (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_ateqsmaller (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_atgreater (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_ateqgreater (int arglist, int rest)
{
  int n, arg1, arg2;
...
//timer
int
b_ctr_set (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_ctr_dec (int arglist, int rest)
{
  int n, arg1, arg2, i;
...
int
b_ctr_inc (int arglist, int rest)
{
  int n, arg1, arg2, i;
...
int
b_asserta (int arglist, int rest)
{
  int n, arg1;
...
int
b_retract (int arglist, int rest)
{
...
int
b_abolish (int arglist, int rest)
{
...
int
b_list_text (int arglist, int rest)
{
...
int
b_atom_concat (int arglist, int rest)
{
...
int
b_atom_string (int arglist, int rest)
{
...
int
b_char_code (int arglist, int rest)
{
...
int
b_string_length (int arglist, int rest)
{
  int n, arg1, arg2, val;
...
int
b_string_term (int arglist, int rest)
{
...
int
b_substring (int arglist, int rest)
{
...
int
b_float_text (int arglist, int rest)
{
  int n, arg1, arg2, arg3;
  ...
  if (n == 3)
      ...
      if (floatp (arg1))
	{
	  ...
	  if (unify (arg3, makeconst ("general")) == YES)
	    ...
	    if (unify (arg3, wcons (makepred ("scientific"), wcons (n, NIL)))
		== YES)
	    {
	      d = GET_INT (deref (n));
	      if (d > 15)
...
int
b_int_text (int arglist, int rest)
{
  int n, arg1, arg2, i;
  char str[STRSIZE];
...
int
b_ifthenelse (int arglist, int rest)
{
...
int
b_measure (int arglist, int rest)
{
  int n, arg1;
...
int
b_notrace (int arglist, int rest)
{
  int n;
...
int
b_integer (int arglist, int rest)
{
  int n, arg1;
...
int
b_compound (int arglist, int rest)
{
  int n, arg1;
...
//-----structure------
int
b_functor (int arglist, int rest)
{
...
//-----other----
int
b_listing (int arglist, int rest)
{
...
int
b_current_predicate (int arglist, int rest)
{
...
int
b_current_op (int arglist, int rest)
{
...
int
b_predicate_property (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_reset_op (int arglist, int rest)
{
  int n;
...
int
b_syntaxerrors (int arglist, int rest)
{
  int n, arg1, arg2, res;
...
int
b_keysort (int arglist, int rest)
{
  int n, arg1, arg2;
...
//listreverse/2
int
b_reverse (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_between (int arglist, int rest)
{
...
int
b_findall (int arglist, int rest)
{
...
int
b_bagofhelper (int arglist, int rest)
{
...
int
b_ansi_cup (int arglist, int rest)
{
  int n, arg1, arg2, r, c;
...
int
b_ansi_cpr (int arglist, int rest)
{
...
int
b_ansi_scp (int arglist, int rest)
{
  int n;
...
int
b_ansi_rcp (int arglist, int rest)
{
  int n;
...
int
b_ansi_ed (int arglist, int rest)
{
  int n;
...
int
b_ansi_el (int arglist, int rest)
{
  int n;
...
int
b_ansi_cuu (int arglist, int rest)
{
  int n, arg1, m;
...
int
b_ansi_cud (int arglist, int rest)
{
  int n, arg1, m;
...
int
b_ansi_cuf (int arglist, int rest)
{
  int n, arg1, m;
...
int
b_ansi_cub (int arglist, int rest)
{
  int n, arg1, m;
...
int
b_ansi_sgr (int arglist, int rest)
{
  int n, arg1, m;
...
int
b_date_day (int arglist, int rest)
{
...
int
b_errorcode (int arglist, int rest)
{
  int n, arg1;
...
int
b_recordh (int arglist, int rest)
{
...
int
b_retrieveh (int arglist, int rest)
{
...
int
b_instance (int arglist, int rest)
{
  int n, arg1, arg2;
...
int
b_recordz (int arglist, int rest)
{
...
int
b_recorda (int arglist, int rest)
{
  int n, arg1, arg2, arg3;
...
int
b_removeh (int arglist, int rest)
{
...
int
b_removeallh (int arglist, int rest)
{
